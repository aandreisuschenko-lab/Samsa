...
Запуск:
    ...
    python run.py <plan.xlsx> --today 2026-07-01 --models data/samsung-creative-brief-template.xlsx
"""
...
def main() -> None:
    ...
    (out / "checks_report.md").write_text(build_checks_report(plan, issues, today), encoding="utf-8")
    (out / "weekly_digest.md").write_text(build_weekly_digest(plan, issues, today), encoding="utf-8")
    ...
    print(f"Результаты: {xlsx}, {out/'checks_report.md'}, {out/'weekly_digest.md'}, {html}")
